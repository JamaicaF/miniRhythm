...
/* harmony import */ var _control_surface__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./control_surface */ "./lib/control_surface.js");
/* harmony import */ var _sequence__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./sequence */ "./lib/sequence.js");
/* harmony import */ var _modal__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modal */ "./lib/modal.js");
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const modal = new _modal__WEBPACK_IMPORTED_MODULE_4__["default"]();
  modal.closeModal();
  modal.openModal();
  ...
  const player = new _player__WEBPACK_IMPORTED_MODULE_1__["default"](data);
  player.triggerPlayback();
  player.adjustTempo();

  const controlSurface = new _control_surface__WEBPACK_IMPORTED_MODULE_2__["default"](canvas, ctx, data.channels);
  controlSurface.draw();
  controlSurface.buildClickHandlers();

  const sequence = new _sequence__WEBPACK_IMPORTED_MODULE_3__["default"](canvas, ctx, data.sequence);
  sequence.draw();
});
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _demo_beats__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./demo_beats */ "./lib/demo_beats.js");
...
class Data {
  constructor() {
    ...
    this.demoBeats = _demo_beats__WEBPACK_IMPORTED_MODULE_0__["demoBeats"];
  }
...
/*!***************************!*\
  !*** ./lib/demo_beats.js ***!
  \***************************/
/*! exports provided: demoBeats, demoBeats2 */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "demoBeats", function() { return demoBeats; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "demoBeats2", function() { return demoBeats2; });
const demoBeats = [
  { channel: "clap", steps: [
...
class Player {
  constructor(data) {
    ...
    this.player = new tone__WEBPACK_IMPORTED_MODULE_0___default.a.Players({
    ...
    this.loop = new tone__WEBPACK_IMPORTED_MODULE_0___default.a.Sequence((time, col) => {
  ...
  adjustTempo() {
    this.tempoSlider.addEventListener('input', () => {
      tone__WEBPACK_IMPORTED_MODULE_0___default.a.Transport.bpm.value = this.tempoSlider.value;
